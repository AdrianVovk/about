      ...
      <div className='pane-item native-key-bindings about'>
        <div className='about-container'>
          <header className='about-header'>
            <a className='about-atom-io' href='https://github.com/AdrianVovk/substance-ide'>
              <AtomLogo />
            </a>
          ...
          <div className='about-love group-start'>
            ...
            <a className='inline' href='https://substanceproject.net/'><span>Substance</span></a>
            <span className='inline'> and </span>
            <a className='inline' href='https://github.com'><span>Github</span></a>
          </div>
          ...
          <div className='about-credits group-item'>
            <span className='inline'>The Substance IDE is an open source fork of </span>
